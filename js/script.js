document.addEventListener('DOMContentLoaded', () => {
    ...
    btnWhatsapp.onclick = () => {
        ...
        let msg = "⭐ *NOVO PEDIDO* ⭐\n\n";
        cart.forEach(item => {
            // A mudança começa aqui: garantindo que os emojis sejam tratados como texto
        ...
        // TROCA ESSA LINHA:
        // De: window.open(`https://wa.me/556992008985?text=${encodeURIComponent(msg)}`, '_blank');
        
        // Para esta versão mais estável (API oficial):
